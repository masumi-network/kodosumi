...
<img className="block dark:hidden" src="/assets/ecosystem.png" alt="Ecosystem" />
<img className="hidden dark:block" src="/assets/ecosystem_dark.png" alt="Ecosystem" />
...
<img className="block dark:hidden" src="/assets/architecture.png" alt="Kodosumi Architecture Overview" />
<img className="hidden dark:block" src="/assets/architecture_dark.png" alt="Kodosumi Architecture Overview" />
