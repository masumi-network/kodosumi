...
## Login Screen
<img src="./panel/thumb/login.png" alt="Login" className="rounded-xl" />
...
## Service Screen
<img src="./panel/thumb/services.png" alt="Services" className="rounded-xl" />
...
## Inputs Form
<img src="./panel/thumb/form.png" alt="Form" className="rounded-xl" />

Kodosumi uses standardized inputs schemes to manage user input.

## Status Screen
<img src="./panel/thumb/status.png" alt="Results" className="rounded-xl" />
...
<img src="./panel/thumb/i-o.png" alt="I/O Streams" className="rounded-xl" />

### Timeline Screen
<img src="./panel/thumb/timeline.png" alt="Timeline" className="rounded-xl" />

## Agentic Control
<img src="./panel/thumb/control.png" alt="Control" className="rounded-xl" />
